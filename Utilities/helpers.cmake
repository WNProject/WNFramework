...
elseif(ANDROID OR ${CMAKE_SYSTEM_NAME} STREQUAL "Android")
  ...
  if (${WN_IS_TEGRA})
    add_compile_options("-DANDROID_NATIVE_API_LEVEL=${CMAKE_ANDROID_API_MIN}")
    set(ANDROID_NATIVE_API_LEVEL "${CMAKE_ANDROID_API_MIN}")
  endif()
...
if (${WN_IS_TEGRA})
  ...
  if (DEFINED CMAKE_ANDROID_ARCH)
    ...
    elseif(${CMAKE_ANDROID_ARCH} STREQUAL "arm64-v8a")
      set(WN_TEGRA_TARGET_TRIPLE "aarch64-none-linux-android")
...
if (NOT LLVM_CONFIGURED)
  ...
  if (${WN_IS_TEGRA})
    ...
    list(APPEND WN_LLVM_EXTRA_FLAGS "-DCMAKE_ANDROID_API_MIN=${CMAKE_ANDROID_API_MIN}")
  endif()
...
function(add_wn_executable target)
  ...
  if ((NOT PARSED_ARGS_MINIMAL_EXECUTABLE OR ${WN_IS_TEGRA})
        AND WN_SYSTEM STREQUAL "Android")
