...
function(build_apk)
  ...
  add_custom_command(TARGET ${WN_TARGET_NAME}
    POST_BUILD
    COMMAND ${CMAKE_COMMAND} -E copy "${SO_NAME}" "${WN_TARGET_DIR}/libs/${ANDROID_ABI}")

  if (CMAKE_BUILD_TYPE STREQUAL "Debug")
    add_custom_command(TARGET ${WN_TARGET_NAME}
      POST_BUILD
      COMMAND ${CMAKE_COMMAND} -E copy "${ANDROID_NDK}/prebuilt/android-${ANDROID_ARCH_NAME}/gdbserver"
        "${WN_TARGET_DIR}/libs/${ANDROID_ABI}/")
  endif()

  if (ANDROID_SDK_DIR)
    add_custom_command(TARGET ${WN_TARGET_NAME}
      COMMAND ${ANDROID_SDK_DIR}/tools/android update project -t 
