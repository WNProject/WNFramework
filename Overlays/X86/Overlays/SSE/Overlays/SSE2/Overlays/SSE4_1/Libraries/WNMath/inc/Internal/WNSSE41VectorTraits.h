...
#include "WNMath/inc/Internal/WNSSE2VectorTraits.h"
...
struct vector_traits_sse4_1 : vector_traits_sse2 {
  ...
  static WN_FORCE_INLINE type length(
      const element_array<type, dimension>& _element_array) {
    return (base::length(_element_array));
  }

  template <>
  static WN_FORCE_INLINE float length(
      const element_array<float, 2>& _element_array) {
  ...
  template <>
  static WN_FORCE_INLINE float length(
      const element_array<float, 3>& _element_array) {
    const __m128 squared = _mm_mul_ps(
        _element_array.m_xmm_values[0], _element_array.m_xmm_values[0]);
  ...
  template <>
  static WN_FORCE_INLINE float length(
      const element_array<float, 4>& _element_array) {
    const __m128 squared = _mm_mul_ps(
        _element_array.m_xmm_values[0], _element_array.m_xmm_values[0]);
  ...
  template <>
  static WN_FORCE_INLINE float length_squared(
      const element_array<float, 2>& _element_array) {
    const __m128 squared = _mm_mul_ps(
        _element_array.m_xmm_values[0], _element_array.m_xmm_values[0]);
  ...
  template <>
  static WN_FORCE_INLINE void normalize(
      element_array<float, 4>& _element_array) {
    const __m128 squared = _mm_mul_ps(
        _element_array.m_xmm_values[0], _element_array.m_xmm_values[0]);
