...
#include "WNPlatform/inc/Internal/WNSurfaceAndroid.h"
...
WNSurfaceManagerReturnCode::type WNSurfaceManagerAndroid::CreateSurface(
  ...
  memory::intrusive_ptr<WNSurfaceAndroid> ptr =
      memory::make_intrusive<WNSurfaceAndroid, WNSurfaceManagerAndroid&>(
          &allocator, *this);
...
WNSurfaceManagerAndroid::WNSurfaceManagerAndroid()
  : mDisplay(EGL_NO_DISPLAY), mConfig(nullptr), mValidSurface(false) {}

bool WNSurfaceManagerAndroid::InitializeDisplay(
    EGLDisplay& _display, EGLConfig& _config) {
  const EGLint attributes[] = {EGL_SURFACE_TYPE, EGL_WINDOW_BIT, EGL_BLUE_SIZE,
