  ...
  run_test(wn::runtime::graphics::k_empty_adapter_features,
      [this](wn::runtime::graphics::adapter::api_type _api,
        ...
        const wn::runtime::graphics::descriptor_binding_info infos[] = {
            {
                ...
                static_cast<uint32_t>(
                    wn::runtime::graphics::shader_stage::vertex),
                wn::runtime::graphics::descriptor_type::
                    read_only_buffer,  // type
            },
            {
                1,  // binding
                0,  // register_base
                1,  // array_size
                static_cast<uint32_t>(
                    wn::runtime::graphics::shader_stage::pixel),
        ...
        auto constant_buffer =
            wn::runtime::graphics::testing::create_and_fill_buffer(_device,
                arena_index,
                wn::runtime::graphics::resource_state::read_only_buffer,
                constants);
        ...
        list->set_scissor(wn::runtime::graphics::scissor{
            static_cast<int32_t>(get_width() / 2), 0, get_width() / 2,
            get_height()});
