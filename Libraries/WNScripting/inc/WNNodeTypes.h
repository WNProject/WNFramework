...
class declaration : public instruction {
 public:
  ...
  const containers::string_view get_name() const { return m_parameter->get_name(); }
...
class script_file : public node {
 public:
  ...
  const wn::containers::deque<wn::memory::allocated_ptr<struct_definition>>& get_structs() const {
    return m_structs;
  }
