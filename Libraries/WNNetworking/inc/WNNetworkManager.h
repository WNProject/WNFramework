...
namespace WNNetworking {
    ...
    typedef wn::containers::function<void(WNConnection*, WNNetworkReadBuffer&)> WNMessageCallback;
    ...
    public:
        ...
        virtual WNNetworkManagerReturnCode::type Initialize(uint32_t _numWorkerThreads) = 0;
        //You do not own this connection, you must ask the network manager to destroy it for you
        virtual WNNetworkManagerReturnCode::type ConnectTo(WNConnection*& _outHandle, WNConnectionType::type _type, const char* _target, uint16_t _port) = 0;
        //You do not own this connection, you must ask the network manager to destroy it for you
        virtual WNNetworkManagerReturnCode::type CreateListener(WNConnection*& _outHandle, WNConnectionType::type _type, uint16_t _port, const WNConnectedCallback& _callback) = 0;
        ...
        void FireCallback(uint32_t _callbackNumber, WNConnection* _connection, WNNetworkReadBuffer& _buffer);

        //You do not own this connection, you must ask the network manager to destroy it for you
        WNNetworkManagerReturnCode::type CreateConnectionGroup(WNConnectionGroup*& _outHandle, const char* _groupName);
