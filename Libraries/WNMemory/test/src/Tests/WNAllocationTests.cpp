...
TYPED_TEST(allocation, malloc_realloc_free) {
    ...
    TypeParam* memory3 = wn::memory::malloc<TypeParam>();
    TypeParam* memory4 = wn::memory::malloc<TypeParam>(4);
    TypeParam* memory5 = static_cast<TypeParam*>(wn::memory::malloc<wn_void>(sizeof(TypeParam)));
    TypeParam* memory6 = static_cast<TypeParam*>(wn::memory::malloc<wn_void>(sizeof(TypeParam) * 4));
    ...
    memory5[0] = static_cast<TypeParam>(11);
    memory6[0] = static_cast<TypeParam>(12);
    memory6[1] = static_cast<TypeParam>(13);
    memory6[2] = static_cast<TypeParam>(14);
    memory6[3] = static_cast<TypeParam>(15);
    ...
    ASSERT_EQ(memory5[0], static_cast<TypeParam>(11));
    ASSERT_EQ(memory6[0], static_cast<TypeParam>(12));
    ASSERT_EQ(memory6[1], static_cast<TypeParam>(13));
    ASSERT_EQ(memory6[2], static_cast<TypeParam>(14));
    ASSERT_EQ(memory6[3], static_cast<TypeParam>(15));

    memory1 = wn::memory::realloc(memory1, 2);
    memory2 = static_cast<TypeParam*>(wn::memory::realloc(static_cast<wn_void*>(memory2), 8 * sizeof(TypeParam)));
    ...
    TypeParam* memory7 = wn::memory::realloc(null_memory, 1);

    ASSERT_NE(memory7, wn_nullptr);

    memory7[0] = static_cast<TypeParam>(66);

    ASSERT_EQ(memory7[0], static_cast<TypeParam>(66));

    wn::memory::free(memory1);
    wn::memory::free(memory2);
    wn::memory::free(memory3);
    wn::memory::free(memory4);
    wn::memory::free(memory5);
    wn::memory::free(memory6);
    wn::memory::free(memory7);
...
TYPED_TEST(allocation, aligned_malloc_realloc_free) {
    ...
    TypeParam* memory3 = wn::memory::aligned_malloc<TypeParam>(16);
    TypeParam* memory4 = wn::memory::aligned_malloc<TypeParam>(4, 16);
    TypeParam* memory5 = static_cast<TypeParam*>(wn::memory::aligned_malloc<wn_void>(sizeof(TypeParam), 16));
    TypeParam* memory6 = static_cast<TypeParam*>(wn::memory::aligned_malloc<wn_void>(sizeof(TypeParam) * 4, 16));
    ...
    memory1 = wn::memory::aligned_realloc(memory1, 2, 16);
    memory2 = static_cast<TypeParam*>(wn::memory::aligned_realloc(static_cast<wn_void*>(memory2), 8 * sizeof(TypeParam), 16));
    ...
    TypeParam* null_memory = wn_nullptr;
    TypeParam* memory7 = wn::memory::aligned_realloc(null_memory, 1, 16);
    ...
    wn::memory::aligned_free(memory4);
    wn::memory::aligned_free(memory5);
    wn::memory::aligned_free(memory6);
    wn::memory::aligned_free(memory7);
...
TYPED_TEST(allocation, construct_destroy) {
    ...
    dummy_construct<TypeParam>* dummy3 = wn::memory::malloc<dummy_construct<TypeParam>>();
    dummy_construct<TypeParam>* dummy4 = wn::memory::malloc<dummy_construct<TypeParam>>();
