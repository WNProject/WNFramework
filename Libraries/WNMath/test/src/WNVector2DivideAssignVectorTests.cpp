...
TEST(WNVector2ValidationUINT8, DivideAssignVectorTest) {
...
TEST(WNVector2ValidationUINT16, DivideAssignVectorTest) {
...
TEST(WNVector2ValidationUINT32, DivideAssignVectorTest) {
...
TEST(WNVector2ValidationUINT64, DivideAssignVectorTest) {
...
TEST(WNVector2ValidationINT8, DivideAssignVectorTest) {
...
TEST(WNVector2ValidationINT16, DivideAssignVectorTest) {
...
TEST(WNVector2ValidationINT32, DivideAssignVectorTest) {
...
TEST(WNVector2ValidationINT64, DivideAssignVectorTest) {
...
TEST(WNVector2ValidationFLOAT16, DivideAssignVectorTest) {
...
TEST(WNVector2ValidationFLOAT32, DivideAssignVectorTest) {
...
TEST(WNVector2ValidationFLOAT64, DivideAssignVectorTest) {
