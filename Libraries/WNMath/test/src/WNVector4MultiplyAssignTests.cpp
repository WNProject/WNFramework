...
TEST(WNVector4ValidationUINT8, MultiplyAssignTest) {
...
TEST(WNVector4ValidationUINT16, MultiplyAssignTest) {
...
TEST(WNVector4ValidationUINT32, MultiplyAssignTest) {
...
TEST(WNVector4ValidationUINT64, MultiplyAssignTest) {
...
TEST(WNVector4ValidationINT8, MultiplyAssignTest) {
...
TEST(WNVector4ValidationINT16, MultiplyAssignTest) {
...
TEST(WNVector4ValidationINT32, MultiplyAssignTest) {
...
TEST(WNVector4ValidationINT64, MultiplyAssignTest) {
...
TEST(WNVector4ValidationFLOAT16, MultiplyAssignTest) {
...
TEST(WNVector4ValidationFLOAT32, MultiplyAssignTest) {
...
TEST(WNVector4ValidationFLOAT64, MultiplyAssignTest) {
