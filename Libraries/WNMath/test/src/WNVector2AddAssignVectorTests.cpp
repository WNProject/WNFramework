...
TEST(WNVector2ValidationUINT8, AddAssignVectorTest) {
...
TEST(WNVector2ValidationUINT16, AddAssignVectorTest) {
...
TEST(WNVector2ValidationUINT32, AddAssignVectorTest) {
...
TEST(WNVector2ValidationUINT64, AddAssignVectorTest) {
...
TEST(WNVector2ValidationINT8, AddAssignVectorTest) {
...
TEST(WNVector2ValidationINT16, AddAssignVectorTest) {
...
TEST(WNVector2ValidationINT32, AddAssignVectorTest) {
...
TEST(WNVector2ValidationINT64, AddAssignVectorTest) {
...
TEST(WNVector2ValidationFLOAT16, AddAssignVectorTest) {
...
TEST(WNVector2ValidationFLOAT32, AddAssignVectorTest) {
...
TEST(WNVector2ValidationFLOAT64, AddAssignVectorTest) {
