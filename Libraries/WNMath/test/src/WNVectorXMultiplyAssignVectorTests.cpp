...
TEST(WNVectorXValidationUINT8, MultiplyAssignVectorTest) {
...
TEST(WNVectorXValidationUINT16, MultiplyAssignVectorTest) {
...
TEST(WNVectorXValidationUINT32, MultiplyAssignVectorTest) {
...
TEST(WNVectorXValidationUINT64, MultiplyAssignVectorTest) {
...
TEST(WNVectorXValidationINT8, MultiplyAssignVectorTest) {
...
TEST(WNVectorXValidationINT16, MultiplyAssignVectorTest) {
...
TEST(WNVectorXValidationINT32, MultiplyAssignVectorTest) {
...
TEST(WNVectorXValidationINT64, MultiplyAssignVectorTest) {
...
TEST(WNVectorXValidationFLOAT16, MultiplyAssignVectorTest) {
...
TEST(WNVectorXValidationFLOAT32, MultiplyAssignVectorTest) {
...
TEST(WNVectorXValidationFLOAT64, MultiplyAssignVectorTest) {
