...
TEST(WNVector4ValidationUINT8, AddAssignTest) {
    ...
    ASSERT_EQ(vector.GetW(), 5);
}

TEST(WNVector4ValidationUINT16, AddAssignTest) {
...
TEST(WNVector4ValidationUINT32, AddAssignTest) {
...
TEST(WNVector4ValidationUINT64, AddAssignTest) {
...
TEST(WNVector4ValidationINT8, AddAssignTest) {
...
TEST(WNVector4ValidationINT16, AddAssignTest) {
...
TEST(WNVector4ValidationINT32, AddAssignTest) {
...
TEST(WNVector4ValidationINT64, AddAssignTest) {
...
TEST(WNVector4ValidationFLOAT16, AddAssignTest) {
    ...
    ASSERT_LT(abs(static_cast<WN_FLOAT32>(vector.GetW() - static_cast<WN_FLOAT16>(5.0f))), ALLOWED_PERCENTAGE_ERROR);
}

TEST(WNVector4ValidationFLOAT32, AddAssignTest) {
    ...
    ASSERT_LT(abs(vector.GetW() - 5.0f), ALLOWED_PERCENTAGE_ERROR);
}

TEST(WNVector4ValidationFLOAT64, AddAssignTest) {
    ...
    ASSERT_LT(abs(vector.GetW() - 5.0), ALLOWED_PERCENTAGE_ERROR);
}
