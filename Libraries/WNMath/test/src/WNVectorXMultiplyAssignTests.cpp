...
TEST(WNVectorXValidationUINT8, MultiplyAssignTest) {
...
TEST(WNVectorXValidationUINT16, MultiplyAssignTest) {
...
TEST(WNVectorXValidationUINT32, MultiplyAssignTest) {
...
TEST(WNVectorXValidationUINT64, MultiplyAssignTest) {
...
TEST(WNVectorXValidationINT8, MultiplyAssignTest) {
...
TEST(WNVectorXValidationINT16, MultiplyAssignTest) {
...
TEST(WNVectorXValidationINT32, MultiplyAssignTest) {
...
TEST(WNVectorXValidationINT64, MultiplyAssignTest) {
...
TEST(WNVectorXValidationFLOAT16, MultiplyAssignTest) {
...
TEST(WNVectorXValidationFLOAT32, MultiplyAssignTest) {
...
TEST(WNVectorXValidationFLOAT64, MultiplyAssignTest) {
