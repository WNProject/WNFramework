...
TEST(WNVectorXValidationUINT8, AddTest) {
...
TEST(WNVectorXValidationUINT16, AddTest) {
...
TEST(WNVectorXValidationUINT32, AddTest) {
...
TEST(WNVectorXValidationUINT64, AddTest) {
...
TEST(WNVectorXValidationINT8, AddTest) {
...
TEST(WNVectorXValidationINT16, AddTest) {
...
TEST(WNVectorXValidationINT32, AddTest) {
...
TEST(WNVectorXValidationINT64, AddTest) {
...
TEST(WNVectorXValidationFLOAT16, AddTest) {
...
TEST(WNVectorXValidationFLOAT32, AddTest) {
...
TEST(WNVectorXValidationFLOAT64, AddTest) {
