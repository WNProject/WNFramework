...
TEST(WNVector3ValidationUINT8, AddTest) {
...
TEST(WNVector3ValidationUINT16, AddTest) {
...
TEST(WNVector3ValidationUINT32, AddTest) {
...
TEST(WNVector3ValidationUINT64, AddTest) {
...
TEST(WNVector3ValidationINT8, AddTest) {
...
TEST(WNVector3ValidationINT16, AddTest) {
...
TEST(WNVector3ValidationINT32, AddTest) {
...
TEST(WNVector3ValidationINT64, AddTest) {
...
TEST(WNVector3ValidationFLOAT16, AddTest) {
...
TEST(WNVector3ValidationFLOAT32, AddTest) {
...
TEST(WNVector3ValidationFLOAT64, AddTest) {
