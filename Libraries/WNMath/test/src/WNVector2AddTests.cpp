...
TEST(WNVector2ValidationUINT8, AddTest) {
...
TEST(WNVector2ValidationUINT16, AddTest) {
...
TEST(WNVector2ValidationUINT32, AddTest) {
...
TEST(WNVector2ValidationUINT64, AddTest) {
...
TEST(WNVector2ValidationINT8, AddTest) {
...
TEST(WNVector2ValidationINT16, AddTest) {
...
TEST(WNVector2ValidationINT32, AddTest) {
...
TEST(WNVector2ValidationINT64, AddTest) {
...
TEST(WNVector2ValidationFLOAT16, AddTest) {
...
TEST(WNVector2ValidationFLOAT32, AddTest) {
...
TEST(WNVector2ValidationFLOAT64, AddTest) {
