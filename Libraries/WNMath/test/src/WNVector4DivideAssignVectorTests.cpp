...
TEST(WNVector4ValidationUINT8, DivideAssignVectorTest) {
    ...
    ASSERT_EQ(vector1.GetW(), 1);
}

TEST(WNVector4ValidationUINT16, DivideAssignVectorTest) {
...
TEST(WNVector4ValidationUINT32, DivideAssignVectorTest) {
...
TEST(WNVector4ValidationUINT64, DivideAssignVectorTest) {
...
TEST(WNVector4ValidationINT8, DivideAssignVectorTest) {
...
TEST(WNVector4ValidationINT16, DivideAssignVectorTest) {
...
TEST(WNVector4ValidationINT32, DivideAssignVectorTest) {
...
TEST(WNVector4ValidationINT64, DivideAssignVectorTest) {
...
TEST(WNVector4ValidationFLOAT16, DivideAssignVectorTest) {
    ...
    ASSERT_LT(abs(static_cast<WN_FLOAT32>(vector1.GetW() - static_cast<WN_FLOAT16>(1.0f))), ALLOWED_PERCENTAGE_ERROR);
}

TEST(WNVector4ValidationFLOAT32, DivideAssignVectorTest) {
    ...
    ASSERT_LT(abs(vector1.GetW() - 1.0f), ALLOWED_PERCENTAGE_ERROR);
}

TEST(WNVector4ValidationFLOAT64, DivideAssignVectorTest) {
    ...
    ASSERT_LT(abs(vector1.GetW() - 1.0), ALLOWED_PERCENTAGE_ERROR);
}
