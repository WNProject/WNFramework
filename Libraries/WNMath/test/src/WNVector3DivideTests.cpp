...
TEST(WNVector3ValidationUINT8, DivideTest) {
...
TEST(WNVector3ValidationUINT16, DivideTest) {
...
TEST(WNVector3ValidationUINT32, DivideTest) {
...
TEST(WNVector3ValidationUINT64, DivideTest) {
...
TEST(WNVector3ValidationINT8, DivideTest) {
...
TEST(WNVector3ValidationINT16, DivideTest) {
...
TEST(WNVector3ValidationINT32, DivideTest) {
...
TEST(WNVector3ValidationINT64, DivideTest) {
...
TEST(WNVector3ValidationFLOAT16, DivideTest) {
...
TEST(WNVector3ValidationFLOAT32, DivideTest) {
...
TEST(WNVector3ValidationFLOAT64, DivideTest) {
