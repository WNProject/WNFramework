...
TEST(WNVectorXValidationUINT8, SubtractTest) {
...
TEST(WNVectorXValidationUINT16, SubtractTest) {
...
TEST(WNVectorXValidationUINT32, SubtractTest) {
...
TEST(WNVectorXValidationUINT64, SubtractTest) {
...
TEST(WNVectorXValidationINT8, SubtractTest) {
...
TEST(WNVectorXValidationINT16, SubtractTest) {
...
TEST(WNVectorXValidationINT32, SubtractTest) {
...
TEST(WNVectorXValidationINT64, SubtractTest) {
...
TEST(WNVectorXValidationFLOAT16, SubtractTest) {
...
TEST(WNVectorXValidationFLOAT32, SubtractTest) {
...
TEST(WNVectorXValidationFLOAT64, SubtractTest) {
