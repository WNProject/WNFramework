...
TEST(WNVector3ValidationUINT8, AddAssignVectorTest) {
...
TEST(WNVector3ValidationUINT16, AddAssignVectorTest) {
...
TEST(WNVector3ValidationUINT32, AddAssignVectorTest) {
...
TEST(WNVector3ValidationUINT64, AddAssignVectorTest) {
...
TEST(WNVector3ValidationINT8, AddAssignVectorTest) {
...
TEST(WNVector3ValidationINT16, AddAssignVectorTest) {
...
TEST(WNVector3ValidationINT32, AddAssignVectorTest) {
...
TEST(WNVector3ValidationINT64, AddAssignVectorTest) {
...
TEST(WNVector3ValidationFLOAT16, AddAssignVectorTest) {
...
TEST(WNVector3ValidationFLOAT32, AddAssignVectorTest) {
...
TEST(WNVector3ValidationFLOAT64, AddAssignVectorTest) {
