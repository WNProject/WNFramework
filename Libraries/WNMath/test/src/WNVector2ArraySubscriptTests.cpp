...
TEST(WNVector2ValidationUINT8, ArraySubscriptTest) {
...
TEST(WNVector2ValidationUINT16, ArraySubscriptTest) {
...
TEST(WNVector2ValidationUINT32, ArraySubscriptTest) {
...
TEST(WNVector2ValidationUINT64, ArraySubscriptTest) {
...
TEST(WNVector2ValidationINT8, ArraySubscriptTest) {
...
TEST(WNVector2ValidationINT16, ArraySubscriptTest) {
...
TEST(WNVector2ValidationINT32, ArraySubscriptTest) {
...
TEST(WNVector2ValidationINT64, ArraySubscriptTest) {
...
TEST(WNVector2ValidationFLOAT16, ArraySubscriptTest) {
...
TEST(WNVector2ValidationFLOAT32, ArraySubscriptTest) {
...
TEST(WNVector2ValidationFLOAT64, ArraySubscriptTest) {
