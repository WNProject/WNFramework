...
TEST(WNVectorXValidationUINT8, FunctionCallTest) {
...
TEST(WNVectorXValidationUINT16, FunctionCallTest) {
...
TEST(WNVectorXValidationUINT32, FunctionCallTest) {
...
TEST(WNVectorXValidationUINT64, FunctionCallTest) {
...
TEST(WNVectorXValidationINT8, FunctionCallTest) {
...
TEST(WNVectorXValidationINT16, FunctionCallTest) {
...
TEST(WNVectorXValidationINT32, FunctionCallTest) {
...
TEST(WNVectorXValidationINT64, FunctionCallTest) {
...
TEST(WNVectorXValidationFLOAT16, FunctionCallTest) {
...
TEST(WNVectorXValidationFLOAT32, FunctionCallTest) {
...
TEST(WNVectorXValidationFLOAT64, FunctionCallTest) {
