...
TEST(WNVectorXValidationUINT16, MultiplySubtractTest) {
...
TEST(WNVectorXValidationUINT32, MultiplySubtractTest) {
...
TEST(WNVectorXValidationUINT64, MultiplySubtractTest) {
...
TEST(WNVectorXValidationINT8, MultiplySubtractTest) {
...
TEST(WNVectorXValidationINT16, MultiplySubtractTest) {
...
TEST(WNVectorXValidationINT32, MultiplySubtractTest) {
...
TEST(WNVectorXValidationINT64, MultiplySubtractTest) {
...
TEST(WNVectorXValidationFLOAT16, MultiplySubtractTest) {
    WNVectorX<WN_FLOAT16, VECTOR_X_DIMENSION> vector = WNVectorX<WN_FLOAT16, VECTOR_X_DIMENSION>(static_cast<WN_FLOAT16>(1.0f));

    vector.MultiplySubtract(static_cast<WN_FLOAT16>(2.0f), static_cast<WN_FLOAT16>(3.0f));
