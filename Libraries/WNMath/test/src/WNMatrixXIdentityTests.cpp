...
TEST(WNMatrixXValidationUINT8, IdentityTest) {
...
TEST(WNMatrixXValidationUINT16, IdentityTest) {
...
TEST(WNMatrixXValidationUINT32, IdentityTest) {
...
TEST(WNMatrixXValidationUINT64, IdentityTest) {
...
TEST(WNMatrixXValidationINT8, IdentityTest) {
...
TEST(WNMatrixXValidationINT16, IdentityTest) {
...
TEST(WNMatrixXValidationINT32, IdentityTest) {
...
TEST(WNMatrixXValidationINT64, IdentityTest) {
...
TEST(WNMatrixXValidationFLOAT16, IdentityTest) {
...
TEST(WNMatrixXValidationFLOAT32, IdentityTest) {
...
TEST(WNMatrixXValidationFLOAT64, IdentityTest) {
