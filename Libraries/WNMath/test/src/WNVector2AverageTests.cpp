...
TEST(WNVector2ValidationUINT8, AverageTest) {
    WNVector2<WN_UINT8> vector1 = WNVector2<WN_UINT8>(1, 2);
    WNVector2<WN_UINT8> vector2 = WNVector2<WN_UINT8>(3, 6);
...
TEST(WNVector2ValidationUINT16, AverageTest) {
    WNVector2<WN_UINT16> vector1 = WNVector2<WN_UINT16>(1, 2);
    WNVector2<WN_UINT16> vector2 = WNVector2<WN_UINT16>(3, 6);
...
TEST(WNVector2ValidationUINT32, AverageTest) {
    WNVector2<WN_UINT32> vector1 = WNVector2<WN_UINT32>(1, 2);
    WNVector2<WN_UINT32> vector2 = WNVector2<WN_UINT32>(3, 6);
...
TEST(WNVector2ValidationUINT64, AverageTest) {
    WNVector2<WN_UINT64> vector1 = WNVector2<WN_UINT64>(1, 2);
    WNVector2<WN_UINT64> vector2 = WNVector2<WN_UINT64>(3, 6);
...
TEST(WNVector2ValidationINT8, AverageTest) {
    WNVector2<WN_INT8> vector1 = WNVector2<WN_INT8>(1, 2);
    WNVector2<WN_INT8> vector2 = WNVector2<WN_INT8>(3, 6);
...
TEST(WNVector2ValidationINT16, AverageTest) {
    WNVector2<WN_INT16> vector1 = WNVector2<WN_INT16>(1, 2);
    WNVector2<WN_INT16> vector2 = WNVector2<WN_INT16>(3, 6);
...
TEST(WNVector2ValidationINT32, AverageTest) {
    WNVector2<WN_INT32> vector1 = WNVector2<WN_INT32>(1, 2);
    WNVector2<WN_INT32> vector2 = WNVector2<WN_INT32>(3, 6);
...
TEST(WNVector2ValidationINT64, AverageTest) {
    WNVector2<WN_INT64> vector1 = WNVector2<WN_INT64>(1, 2);
    WNVector2<WN_INT64> vector2 = WNVector2<WN_INT64>(3, 6);
...
TEST(WNVector2ValidationFLOAT16, AverageTest) {
    WNVector2<WN_FLOAT16> vector1 = WNVector2<WN_FLOAT16>(static_cast<WN_FLOAT16>(1.0f), static_cast<WN_FLOAT16>(2.0f));
    WNVector2<WN_FLOAT16> vector2 = WNVector2<WN_FLOAT16>(static_cast<WN_FLOAT16>(3.0f), static_cast<WN_FLOAT16>(6.0f));
...
TEST(WNVector2ValidationFLOAT32, AverageTest) {
    WNVector2<WN_FLOAT32> vector1 = WNVector2<WN_FLOAT32>(1.0f, 2.0f);
    WNVector2<WN_FLOAT32> vector2 = WNVector2<WN_FLOAT32>(3.0f, 6.0f);
...
TEST(WNVector2ValidationFLOAT64, AverageTest) {
    WNVector2<WN_FLOAT64> vector1 = WNVector2<WN_FLOAT64>(1.0, 2.0);
    WNVector2<WN_FLOAT64> vector2 = WNVector2<WN_FLOAT64>(3.0, 6.0);
