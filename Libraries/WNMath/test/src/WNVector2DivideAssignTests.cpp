...
TEST(WNVector2ValidationUINT8, DivideAssignTest) {
...
TEST(WNVector2ValidationUINT16, DivideAssignTest) {
...
TEST(WNVector2ValidationUINT32, DivideAssignTest) {
...
TEST(WNVector2ValidationUINT64, DivideAssignTest) {
...
TEST(WNVector2ValidationINT8, DivideAssignTest) {
...
TEST(WNVector2ValidationINT16, DivideAssignTest) {
...
TEST(WNVector2ValidationINT32, DivideAssignTest) {
...
TEST(WNVector2ValidationINT64, DivideAssignTest) {
...
TEST(WNVector2ValidationFLOAT16, DivideAssignTest) {
...
TEST(WNVector2ValidationFLOAT32, DivideAssignTest) {
...
TEST(WNVector2ValidationFLOAT64, DivideAssignTest) {
