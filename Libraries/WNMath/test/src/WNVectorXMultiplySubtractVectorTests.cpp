...
TEST(WNVectorXValidationUINT8, MultiplySubtractVectorTest) {
    ...
    WNVectorX<WN_UINT8, VECTOR_X_DIMENSION> vector3 = WNVectorX<WN_UINT8, VECTOR_X_DIMENSION>(1);

    vector1.MultiplySubtract(vector2, vector3);

    for (WN_UINT32 i = 0; i < VECTOR_X_DIMENSION; ++i) {
        ASSERT_EQ(vector1[i], 0);
    }
}

TEST(WNVectorXValidationUINT16, MultiplySubtractVectorTest) {
    ...
    WNVectorX<WN_UINT16, VECTOR_X_DIMENSION> vector3 = WNVectorX<WN_UINT16, VECTOR_X_DIMENSION>(1);
...
TEST(WNVectorXValidationUINT32, MultiplySubtractVectorTest) {
    ...
    WNVectorX<WN_UINT32, VECTOR_X_DIMENSION> vector3 = WNVectorX<WN_UINT32, VECTOR_X_DIMENSION>(1);
...
TEST(WNVectorXValidationUINT64, MultiplySubtractVectorTest) {
    ...
    WNVectorX<WN_UINT64, VECTOR_X_DIMENSION> vector3 = WNVectorX<WN_UINT64, VECTOR_X_DIMENSION>(1);
...
TEST(WNVectorXValidationINT8, MultiplySubtractVectorTest) {
    ...
    WNVectorX<WN_INT8, VECTOR_X_DIMENSION> vector3 = WNVectorX<WN_INT8, VECTOR_X_DIMENSION>(1);
...
TEST(WNVectorXValidationINT16, MultiplySubtractVectorTest) {
    ...
    WNVectorX<WN_INT16, VECTOR_X_DIMENSION> vector3 = WNVectorX<WN_INT16, VECTOR_X_DIMENSION>(1);
...
TEST(WNVectorXValidationINT32, MultiplySubtractVectorTest) {
    ...
    WNVectorX<WN_INT32, VECTOR_X_DIMENSION> vector3 = WNVectorX<WN_INT32, VECTOR_X_DIMENSION>(1);
...
TEST(WNVectorXValidationINT64, MultiplySubtractVectorTest) {
    ...
    WNVectorX<WN_INT64, VECTOR_X_DIMENSION> vector3 = WNVectorX<WN_INT64, VECTOR_X_DIMENSION>(1);
...
TEST(WNVectorXValidationFLOAT16, MultiplySubtractVectorTest) {
    ...
    WNVectorX<WN_FLOAT16, VECTOR_X_DIMENSION> vector3 = WNVectorX<WN_FLOAT16, VECTOR_X_DIMENSION>(static_cast<WN_FLOAT16>(1.0f));

    vector1.MultiplySubtract(vector2, vector3);

    for (WN_UINT32 i = 0; i < VECTOR_X_DIMENSION; ++i) {
        ASSERT_LT(abs(static_cast<WN_FLOAT32>(vector1[i] - static_cast<WN_FLOAT16>(0.0f))), ALLOWED_PERCENTAGE_ERROR);
    }
}

TEST(WNVectorXValidationFLOAT32, MultiplySubtractVectorTest) {
    ...
    WNVectorX<WN_FLOAT32, VECTOR_X_DIMENSION> vector3 = WNVectorX<WN_FLOAT32, VECTOR_X_DIMENSION>(1.0f);

    vector1.MultiplySubtract(vector2, vector3);

    for (WN_UINT32 i = 0; i < VECTOR_X_DIMENSION; ++i) {
        ASSERT_LT(abs(vector1[i] - 0.0f), ALLOWED_PERCENTAGE_ERROR);
    }
}

TEST(WNVectorXValidationFLOAT64, MultiplySubtractVectorTest) {
    ...
    WNVectorX<WN_FLOAT64, VECTOR_X_DIMENSION> vector3 = WNVectorX<WN_FLOAT64, VECTOR_X_DIMENSION>(1.0);

    vector1.MultiplySubtract(vector2, vector3);

    for (WN_UINT32 i = 0; i < VECTOR_X_DIMENSION; ++i) {
        ASSERT_LT(abs(vector1[i] - 0.0), ALLOWED_PERCENTAGE_ERROR);
    }
}
