...
TEST(WNVector2ValidationUINT8, MultiplyAssignTest) {
...
TEST(WNVector2ValidationUINT16, MultiplyAssignTest) {
...
TEST(WNVector2ValidationUINT32, MultiplyAssignTest) {
...
TEST(WNVector2ValidationUINT64, MultiplyAssignTest) {
...
TEST(WNVector2ValidationINT8, MultiplyAssignTest) {
...
TEST(WNVector2ValidationINT16, MultiplyAssignTest) {
...
TEST(WNVector2ValidationINT32, MultiplyAssignTest) {
...
TEST(WNVector2ValidationINT64, MultiplyAssignTest) {
...
TEST(WNVector2ValidationFLOAT16, MultiplyAssignTest) {
...
TEST(WNVector2ValidationFLOAT32, MultiplyAssignTest) {
...
TEST(WNVector2ValidationFLOAT64, MultiplyAssignTest) {
