...
TEST(WNVector3ValidationUINT8, FunctionCallTest) {
...
TEST(WNVector3ValidationUINT16, FunctionCallTest) {
...
TEST(WNVector3ValidationUINT32, FunctionCallTest) {
...
TEST(WNVector3ValidationUINT64, FunctionCallTest) {
...
TEST(WNVector3ValidationINT8, FunctionCallTest) {
...
TEST(WNVector3ValidationINT16, FunctionCallTest) {
...
TEST(WNVector3ValidationINT32, FunctionCallTest) {
...
TEST(WNVector3ValidationINT64, FunctionCallTest) {
...
TEST(WNVector3ValidationFLOAT16, FunctionCallTest) {
...
TEST(WNVector3ValidationFLOAT32, FunctionCallTest) {
...
TEST(WNVector3ValidationFLOAT64, FunctionCallTest) {
