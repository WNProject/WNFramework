...
TEST(WNVectorXValidationUINT8, DivideAssignTest) {
...
TEST(WNVectorXValidationUINT16, DivideAssignTest) {
...
TEST(WNVectorXValidationUINT32, DivideAssignTest) {
...
TEST(WNVectorXValidationUINT64, DivideAssignTest) {
...
TEST(WNVectorXValidationINT8, DivideAssignTest) {
...
TEST(WNVectorXValidationINT16, DivideAssignTest) {
...
TEST(WNVectorXValidationINT32, DivideAssignTest) {
...
TEST(WNVectorXValidationINT64, DivideAssignTest) {
...
TEST(WNVectorXValidationFLOAT16, DivideAssignTest) {
...
TEST(WNVectorXValidationFLOAT32, DivideAssignTest) {
...
TEST(WNVectorXValidationFLOAT64, DivideAssignTest) {
