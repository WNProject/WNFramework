...
TEST(WNVectorXValidationUINT8, DivideTest) {
...
TEST(WNVectorXValidationUINT16, DivideTest) {
...
TEST(WNVectorXValidationUINT32, DivideTest) {
...
TEST(WNVectorXValidationUINT64, DivideTest) {
...
TEST(WNVectorXValidationINT8, DivideTest) {
...
TEST(WNVectorXValidationINT16, DivideTest) {
...
TEST(WNVectorXValidationINT32, DivideTest) {
...
TEST(WNVectorXValidationINT64, DivideTest) {
...
TEST(WNVectorXValidationFLOAT16, DivideTest) {
...
TEST(WNVectorXValidationFLOAT32, DivideTest) {
...
TEST(WNVectorXValidationFLOAT64, DivideTest) {
