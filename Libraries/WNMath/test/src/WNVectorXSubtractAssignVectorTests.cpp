...
TEST(WNVectorXValidationUINT8, SubtractAssignVectorTest) {
...
TEST(WNVectorXValidationUINT16, SubtractAssignVectorTest) {
...
TEST(WNVectorXValidationUINT32, SubtractAssignVectorTest) {
...
TEST(WNVectorXValidationUINT64, SubtractAssignVectorTest) {
...
TEST(WNVectorXValidationINT8, SubtractAssignVectorTest) {
...
TEST(WNVectorXValidationINT16, SubtractAssignVectorTest) {
...
TEST(WNVectorXValidationINT32, SubtractAssignVectorTest) {
...
TEST(WNVectorXValidationINT64, SubtractAssignVectorTest) {
...
TEST(WNVectorXValidationFLOAT16, SubtractAssignVectorTest) {
    ...
    for (WN_UINT32 i = 0; i < VECTOR_X_DIMENSION; ++i) {
        ASSERT_LT(abs(static_cast<WN_FLOAT32>(vector1[i])), ALLOWED_PERCENTAGE_ERROR);
    }
}

TEST(WNVectorXValidationFLOAT32, SubtractAssignVectorTest) {
    ...
    for (WN_UINT32 i = 0; i < VECTOR_X_DIMENSION; ++i) {
        ASSERT_LT(abs(vector1[i]), ALLOWED_PERCENTAGE_ERROR);
    }
}

TEST(WNVectorXValidationFLOAT64, SubtractAssignVectorTest) {
