...
TEST(WNVector4ValidationUINT8, FunctionCallTest) {
...
TEST(WNVector4ValidationUINT16, FunctionCallTest) {
...
TEST(WNVector4ValidationUINT32, FunctionCallTest) {
...
TEST(WNVector4ValidationUINT64, FunctionCallTest) {
...
TEST(WNVector4ValidationINT8, FunctionCallTest) {
...
TEST(WNVector4ValidationINT16, FunctionCallTest) {
...
TEST(WNVector4ValidationINT32, FunctionCallTest) {
...
TEST(WNVector4ValidationINT64, FunctionCallTest) {
...
TEST(WNVector4ValidationFLOAT16, FunctionCallTest) {
...
TEST(WNVector4ValidationFLOAT32, FunctionCallTest) {
...
TEST(WNVector4ValidationFLOAT64, FunctionCallTest) {
