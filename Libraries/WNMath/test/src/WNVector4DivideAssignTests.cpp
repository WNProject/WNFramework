...
TEST(WNVector4ValidationUINT8, DivideAssignTest) {
...
TEST(WNVector4ValidationUINT16, DivideAssignTest) {
...
TEST(WNVector4ValidationUINT32, DivideAssignTest) {
...
TEST(WNVector4ValidationUINT64, DivideAssignTest) {
...
TEST(WNVector4ValidationINT8, DivideAssignTest) {
...
TEST(WNVector4ValidationINT16, DivideAssignTest) {
...
TEST(WNVector4ValidationINT32, DivideAssignTest) {
...
TEST(WNVector4ValidationINT64, DivideAssignTest) {
...
TEST(WNVector4ValidationFLOAT16, DivideAssignTest) {
...
TEST(WNVector4ValidationFLOAT32, DivideAssignTest) {
...
TEST(WNVector4ValidationFLOAT64, DivideAssignTest) {
