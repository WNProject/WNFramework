...
inline typename core::enable_if<core::is_signed<_Type>::value, _Type>::type abs(
    const _Type& _value) {
...
template <typename _Type>
inline typename core::enable_if<(core::is_floating_point<_Type>::value ||
...
template <typename _Type>
inline _Type pow(const _Type& _base, const _Type& _exponent) {
  return (math::internal::basic_traits::pow(_base, _exponent));
}

template <typename _Type>
inline _Type min(const _Type& _value1, const _Type& _value2) {
  return (math::internal::basic_traits::min(_value1, _value2));
}

template <typename _Type>
inline _Type max(const _Type& _value1, const _Type& _value2) {
  return (math::internal::basic_traits::max(_value1, _value2));
}

template <typename _Type>
inline _Type clamp(const _Type& _value, const _Type& _min, const _Type& _max) {
  return (math::internal::basic_traits::clamp(_value, _min, _max));
}

template <typename _Type>
inline _Type deg_to_rad(const _Type& _value) {
  return (static_cast<_Type>(static_cast<double>(_value) * (WN_PI / 180.0)));
}

template <typename _Type>
inline _Type rad_to_deg(const _Type& _value) {
...
inline uint8_t popcount(uint32_t value) {
...
template <typename T>
inline uint8_t popcount_sparse(T value) {
  uint8_t count = 0;
  while (value) {
    count++;
    value &= (value - 1);
...
inline uint8_t trailing_zeros(uint32_t value) {
...
inline uint8_t trailing_zeros(uint64_t value) {
  // table from
