...
#error                                                                         \
    "WNLine3.inl should never be included directly. Please include WNLine3.h instead"
#endif
...
WNLine3<type>::WNLine3(const type* _numbers)
  : mPoint1(&_numbers[0]), mPoint2(&_numbers[3]) {}

template <typename type>
WNLine3<type>::WNLine3(
    const WNVector3<type>& _point1, const WNVector3<type>& _point2)
