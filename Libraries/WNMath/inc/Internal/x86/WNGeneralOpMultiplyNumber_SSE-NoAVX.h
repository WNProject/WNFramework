...
#ifndef __WN_MATH_INTERNAL_X86_GENERAL_OP_MULTIPLY_NUMBER_SSE_NO_AVX_H__
#define __WN_MATH_INTERNAL_X86_GENERAL_OP_MULTIPLY_NUMBER_SSE_NO_AVX_H__
...
namespace WNMath {
    namespace __WNInternal {
        ...
        class __WNGeneralOpMultiplyNumber<WN_FLOAT32, Dimension, typename WNCore::WNEnableWhen<(Dimension >= 5 && (Dimension % 4) == 0)>::Value> {
        public:
            static WN_FORCE_INLINE __WNElements<WN_FLOAT32, Dimension>& Execute(__WNElements<WN_FLOAT32, Dimension>& _elements, const WN_FLOAT32& _number) {
                ...
                for (WN_UINT32 i = 0; i < __WNNumberRegisters_XMM_PS<Dimension>::Value; ++i) {
                    _elements.mXMMValues[i] = _mm_mul_ps(_elements.mXMMValues[i], number);
                }
        ...
        template <WN_UINT32 Dimension>
        class __WNGeneralOpMultiplyNumber<WN_FLOAT32, Dimension, typename WNCore::WNEnableWhen<(Dimension >= 5 && (Dimension % 4) == 1)>::Value> {
        public:
            static WN_FORCE_INLINE __WNElements<WN_FLOAT32, Dimension>& Execute(__WNElements<WN_FLOAT32, Dimension>& _elements, const WN_FLOAT32& _number) {
                const __m128 number = _mm_set1_ps(_number);
                ...
                _elements.mXMMValues[lastElement] = _mm_mul_ss(_elements.mXMMValues[lastElement], number);
        ...
        template <WN_UINT32 Dimension>
        class __WNGeneralOpMultiplyNumber<WN_FLOAT32, Dimension, typename WNCore::WNEnableWhen<(Dimension >= 5 && (Dimension % 4) == 2)>::Value> {
        public:
            static WN_FORCE_INLINE __WNElements<WN_FLOAT32, Dimension>& Execute(__WNElements<WN_FLOAT32, Dimension>& _elements, const WN_FLOAT32& _number) {
                const __m128 number = _mm_set1_ps(_number);
        ...
        template <WN_UINT32 Dimension>
        class __WNGeneralOpMultiplyNumber<WN_FLOAT32, Dimension, typename WNCore::WNEnableWhen<(Dimension >= 5 && (Dimension % 4) == 3)>::Value> {
        public:
            static WN_FORCE_INLINE __WNElements<WN_FLOAT32, Dimension>& Execute(__WNElements<WN_FLOAT32, Dimension>& _elements, const WN_FLOAT32& _number) {
                const __m128 number = _mm_set1_ps(_number);
                const WN_UINT32 count = __WNNumberRegisters_XMM_PS<Dimension>::Value;
...
#endif // __WN_MATH_INTERNAL_X86_GENERAL_OP_MULTIPLY_NUMBER_SSE_NO_AVX_H__