...
namespace wn {
    namespace internal {
        ...
        WN_FORCE_INLINE WNVector<type> __WNMatrix4Base<type, typename std::enable_if<wn::is_real<type>::value>::type>::TransformVector(const WNVector<type>& _vector) const {
        ...
        template <typename type>
        WN_FORCE_INLINE WNVector<type> __WNMatrix4Base<type, typename std::enable_if<wn::is_real<type>::value>::type>::TransformVector(const WNVector<type>& _vector, type& _wComponent) const {
        ...
        template <typename type>
        WN_FORCE_INLINE WNVector4<type> __WNMatrix4Base<type, typename std::enable_if<wn::is_real<type>::value>::type>::TransformVector(const WNVector4<type>& _vector) const {
        ...
        template <typename type>
        WN_FORCE_INLINE WNVector<type>& __WNMatrix4Base<type, typename std::enable_if<wn::is_real<type>::value>::type>::TransformVectorInPlace(WNVector<type>& _vector) const {
        ...
        template <typename type>
        WN_FORCE_INLINE WNVector<type>& __WNMatrix4Base<type, typename std::enable_if<wn::is_real<type>::value>::type>::TransformVectorInPlace(WNVector<type>& _vector, type& _wComponent) const {
            WNVector4<type> vector = _vector.ToVector4();
        ...
        template <typename type>
        WN_FORCE_INLINE WNVector4<type>& __WNMatrix4Base<type, typename std::enable_if<wn::is_real<type>::value>::type>::TransformVectorInPlace(WNVector4<type>& _vector) const {
            const type x = _vector.GetX();
            const type y = _vector.GetY();
            const type z = _vector.GetZ();
        ...
        template <typename type>
        WN_FORCE_INLINE WNMatrix4<type> __WNMatrix4Base<type, typename std::enable_if<wn::is_real<type>::value>::type>::CreateRotation(const WNQuaternion<type>& _rotation) {
        ...
        template <typename type>
        WN_FORCE_INLINE WNMatrix4<type> __WNMatrix4Base<type, typename std::enable_if<wn::is_real<type>::value>::type>::CreateRotationX(const type& _angle) {
            WNMatrix4<type> matrix;
        ...
        template <typename type>
        WN_FORCE_INLINE WNMatrix4<type> __WNMatrix4Base<type, typename std::enable_if<wn::is_real<type>::value>::type>::CreateRotationY(const type& _angle) {
            WNMatrix4<type> matrix;
        ...
        template <typename type>
        WN_FORCE_INLINE WNMatrix4<type> __WNMatrix4Base<type, typename std::enable_if<wn::is_real<type>::value>::type>::CreateRotationZ(const type& _angle) {
            WNMatrix4<type> matrix;
        ...
        template <typename type>
        WN_FORCE_INLINE WNMatrix4<type> __WNMatrix4Base<type, typename std::enable_if<wn::is_real<type>::value>::type>::CreateRotationAxis(const type& _angle, const WNVector<type>& _axis) {
            WNMatrix4<type> matrix;
        ...
        template <typename type>
        WN_FORCE_INLINE WNMatrix4<type> __WNMatrix4Base<type, typename std::enable_if<wn::is_real<type>::value>::type>::CreateRotationAxis(const type& _angle, const type& _x, const type& _y, const type& _z) {
            WNMatrix4<type> matrix;
        ...
        template <typename type>
        WN_FORCE_INLINE WNMatrix4<type> __WNMatrix4Base<type, typename std::enable_if<wn::is_real<type>::value>::type>::CreatePerspective(const type& _fov, const type& _aspect, const type& _near, const type& _far) {
        ...
        template <typename type>
        WN_FORCE_INLINE WNMatrix4<type> __WNMatrix4Base<type, typename std::enable_if<wn::is_real<type>::value>::type>::CreateOrthographic(const type& _width, const type& _height, const type& _near, const type& _far) {
        ...
        template <typename type>
        WN_FORCE_INLINE WNMatrix4<type> __WNMatrix4Base<type, typename std::enable_if<wn::is_real<type>::value>::type>::CreateView(const WNVector<type>& _position, const WNVector<type>& _target, const WNVector<type>& _up) {
