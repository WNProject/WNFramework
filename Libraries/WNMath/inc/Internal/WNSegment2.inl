...
#error                                                                         \
    "WNSegment2.inl should never be included directly. Please include WNSegment2.h instead"
#endif
...
WNSegment2<type>::WNSegment2(const type* _numbers)
  : mStart(_numbers[0], _numbers[1]), mEnd(_numbers[2], _numbers[3]) {}

template <typename type>
WNSegment2<type>::WNSegment2(
    const WNVector2<type>& _point1, const WNVector2<type>& _point2)
  : mStart(_point1), mEnd(_point2) {}
...
template <typename type>
bool WNSegment2<type>::operator==(const WNSegment2<type>& _segment) const {
...
template <typename type>
void WNSegment2<type>::Zero() {
  mStart.Zero();
  mEnd.Zero();
}

template <typename type>
void WNSegment2<type>::Set(const type* _numbers) {
