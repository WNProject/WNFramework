...
#ifndef __WN_MATH_INTERNAL_GENERAL_OP_DIVIDE_H__
#define __WN_MATH_INTERNAL_GENERAL_OP_DIVIDE_H__
...
namespace WNMath {
    namespace __WNInternal {
        ...
        private:
            WN_FORCE_INLINE __WNGeneralHelperDivide() {}
        };

        template <typename Type>
        class __WNGeneralHelperDivide<Type, 1> {
        public:
        ...
        template <typename Type>
        class __WNGeneralHelperDivide<Type, 2> {
        public:
        ...
        template <typename Type>
        class __WNGeneralHelperDivide<Type, 3> {
        public:
        ...
        template <typename Type>
        class __WNGeneralHelperDivide<Type, 4> {
        public:
        ...
        class __WNGeneralOpDivide {
            WN_STATIC_ASSERT_DESC(Dimension > 0, "Must have a dimension of at least 1");

        public:
            static WN_FORCE_INLINE __WNElements<Type, Dimension>& Execute(__WNElements<Type, Dimension>& _elements1, const __WNElements<Type, Dimension>& _elements2) {
                return(__WNGeneralHelperDivide<Type, Dimension>::Execute(_elements1, _elements2));
            }
...
#include "WNMath/inc/WNConfig.h"
    ...
    #ifdef _WN_X86
        #include "WNMath/inc/Internal/x86/WNGeneralOpDivide.h"
    #endif
#endif

#endif // __WN_MATH_INTERNAL_GENERAL_OP_DIVIDE_H__