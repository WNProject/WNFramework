...
#error                                                                         \
    "Internal/WNMatrix2.inl should never be included directly. Please include WNMatrix2.h instead"
#endif
...
template <typename type>
WN_FORCE_INLINE WNMatrix2<type> operator+(
    const type& _number, const WNMatrix2<type>& _matrix) {
