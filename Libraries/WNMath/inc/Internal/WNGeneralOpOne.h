...
#ifndef __WN_MATH_INTERNAL_GENERAL_OP_ONE_H__
#define __WN_MATH_INTERNAL_GENERAL_OP_ONE_H__
...
namespace WNMath {
    namespace __WNInternal {
        ...
        public:
            static WN_FORCE_INLINE __WNElements<Type, Dimension>& Execute(__WNElements<Type, Dimension>& _elements) {
                for (WN_UINT32 i = 0; i < Dimension; ++i) {
                    _elements.mValues[i] = static_cast<Type>(1);
                }
        ...
        private:
            WN_FORCE_INLINE __WNGeneralHelperOne() {}
        };

        template <typename Type>
        class __WNGeneralHelperOne<Type, 1> {
        public:
        ...
        class __WNGeneralOpOne {
        public:
            static WN_FORCE_INLINE __WNElements<Type, Dimension>& Execute(__WNElements<Type, Dimension>& _elements) {
                return(__WNGeneralHelperOne<Type, Dimension>::Execute(_elements));
            }
...
#include "WNMath/inc/WNConfig.h"
    ...
    #ifdef _WN_X86
        #include "WNMath/inc/Internal/x86/WNGeneralOpOne.h"
    #endif
#endif

#endif // __WN_MATH_INTERNAL_GENERAL_OP_ONE_H__
