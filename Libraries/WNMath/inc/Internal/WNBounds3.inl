...
#error                                                                         \
    "WNBounds3.inl should never be included directly. Please include WNBounds3.h instead"
#endif
...
WNBounds3<type>::WNBounds3(const WNVector<type>& _vector)
  : mMinimum(_vector), mMaximum(_vector) {}

template <typename type>
WNBounds3<type>::WNBounds3(
    const WNVector<type>& _min, const WNVector<type>& _max)
  : mMinimum(_min), mMaximum(_max) {}
...
wn_bool WNBounds3<type>::Expand(const WNBox<type>& _box) {
  ...
  const WNVector<type> point2 =
      _box.mLocation + WNVector<type>(-extents.mX, extents.mY, extents.mZ);
  const WNVector<type> point3 =
      _box.mLocation + WNVector<type>(extents.mX, -extents.mY, extents.mZ);
  const WNVector<type> point4 =
      _box.mLocation + WNVector<type>(extents.mX, extents.mY, -extents.mZ);
  const WNVector<type> point5 =
      _box.mLocation + WNVector<type>(-extents.mX, -extents.mY, extents.mZ);
  const WNVector<type> point6 =
      _box.mLocation + WNVector<type>(extents.mX, -extents.mY, -extents.mZ);
  const WNVector<type> point7 =
      _box.mLocation + WNVector<type>(-extents.mX, extents.mY, -extents.mZ);
  const WNVector<type> point8 = _box.mLocation - extents;

  return (Expand(point1) || Expand(point2) || Expand(point3) ||
          Expand(point4) || Expand(point5) || Expand(point6) ||
          Expand(point7) || Expand(point8));
}

template <typename type>
wn_bool WNBounds3<type>::Expand(const WNSphere<type>& _sphere) {
  const WNVector<type> point1 =
      WNVector<type>(_sphere.mLocation.mX + _sphere.mRadius,
          _sphere.mLocation.mY, _sphere.mLocation.mZ);
  const WNVector<type> point2 =
      WNVector<type>(_sphere.mLocation.mX - _sphere.mRadius,
          _sphere.mLocation.mY, _sphere.mLocation.mZ);
  const WNVector<type> point3 = WNVector<type>(_sphere.mLocation.mX,
      _sphere.mLocation.mY + _sphere.mRadius, _sphere.mLocation.mZ);
  const WNVector<type> point4 = WNVector<type>(_sphere.mLocation.mX,
      _sphere.mLocation.mY - _sphere.mRadius, _sphere.mLocation.mZ);
  const WNVector<type> point5 = WNVector<type>(_sphere.mLocation.mX,
      _sphere.mLocation.mY, _sphere.mLocation.mZ + _sphere.mRadius);
  const WNVector<type> point6 = WNVector<type>(_sphere.mLocation.mX,
      _sphere.mLocation.mY, _sphere.mLocation.mZ - _sphere.mRadius);
...
template <typename type>
WNBounds3<type> WNBounds3<type>::GetExpanded(
    const WNVector<type>& _vector) const {
  WNBounds3<type> bounds = *this;
...
template <typename type>
WNBounds3<type> WNBounds3<type>::GetExpanded(
    const WNSphere<type>& _sphere) const {
  WNBounds3<type> bounds = *this;
...
template <typename type>
WNBounds3<type> WNBounds3<type>::GetExpanded(
    const WNBounds3<type>& _bounds) const {
  WNBounds3<type> bounds = *this;
...
template <typename type>
WNBounds3<type> WNBounds3<type>::GetTranslated(
    const WNVector<type>& _vector) const {
  WNBounds3<type> bounds = *this;
...
wn_void WNBounds3<type>::GetPoints(WNVector<type>* _vectors) const {
  _vectors[0] = mMaximum;
  _vectors[6] = mMinimum;
  _vectors[1] = (mMinimum * WNVector<type>(static_cast<type>(0),
                                static_cast<type>(1), static_cast<type>(0)) +
                    mMaximum * WNVector<type>(static_cast<type>(1),
                                   static_cast<type>(0), static_cast<type>(1)))
                    .ToPoint3();
  _vectors[2] = (mMinimum * WNVector<type>(static_cast<type>(1),
                                static_cast<type>(1), static_cast<type>(0)) +
                    mMaximum * WNVector<type>(static_cast<type>(0),
                                   static_cast<type>(0), static_cast<type>(1)))
                    .ToPoint3();
  _vectors[3] = (mMinimum * WNVector<type>(static_cast<type>(1),
                                static_cast<type>(0), static_cast<type>(0)) +
                    mMaximum * WNVector<type>(static_cast<type>(0),
                                   static_cast<type>(1), static_cast<type>(1)))
                    .ToPoint3();
  _vectors[4] = (mMinimum * WNVector<type>(static_cast<type>(0),
                                static_cast<type>(0), static_cast<type>(1)) +
                    mMaximum * WNVector<type>(static_cast<type>(1),
                                   static_cast<type>(1), static_cast<type>(0)))
                    .ToPoint3();
  _vectors[5] = (mMinimum * WNVector<type>(static_cast<type>(0),
                                static_cast<type>(1), static_cast<type>(1)) +
                    mMaximum * WNVector<type>(static_cast<type>(1),
                                   static_cast<type>(0), static_cast<type>(0)))
                    .ToPoint3();
  _vectors[7] = (mMinimum * WNVector<type>(static_cast<type>(1),
                                static_cast<type>(0), static_cast<type>(1)) +
                    mMaximum * WNVector<type>(static_cast<type>(1),
                                   static_cast<type>(1), static_cast<type>(0)))
                    .ToPoint3();
