...
#error                                                                         \
    "WNQuaternion.inl should never be included directly. Please include WNQuaternion.h instead"
#endif
...
WN_FORCE_INLINE WNQuaternion<type>::WNQuaternion(
    const WNQuaternion<type>& _quaternion) {
...
WN_FORCE_INLINE WNMatrix3<type> WNQuaternion<type>::ToMatrix3() const {
  ...
  return (WNMatrix3<type>(static_cast<type>(1) - (yy + zz), xy - wz, xz + wy,
      xy + wz, static_cast<type>(1) - (xx + zz), yz - wx, xz - wy, yz + wx,
      static_cast<type>(1) - (xx + yy)));
}
...
WN_FORCE_INLINE WNMatrix4<type> WNQuaternion<type>::ToMatrix4() const {
  ...
  return (WNMatrix4<type>(static_cast<type>(1) - (yy + zz), xy - wz, xz + wy,
      static_cast<type>(0), xy + wz, static_cast<type>(1) - (xx + zz), yz - wx,
      static_cast<type>(0), xz - wy, yz + wx, static_cast<type>(1) - (xx + yy),
      static_cast<type>(0), static_cast<type>(0), static_cast<type>(0),
...
WN_FORCE_INLINE WNQuaternion<NewType> WNQuaternion<type>::ConvertTo() const {
  return (WNQuaternion<NewType>(static_cast<NewType>(this->mElements[0]),
      static_cast<NewType>(this->mElements[1]),
      static_cast<NewType>(this->mElements[2]),
      static_cast<NewType>(this->mElements[3])));
}

template <typename type>
WN_FORCE_INLINE WNQuaternion<type> operator*(
    const type& _number, const WNQuaternion<type>& _quaternion) {
