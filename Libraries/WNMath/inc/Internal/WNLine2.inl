...
#error                                                                         \
    "WNLine2.inl should never be included directly. Please include WNLine2.h instead"
#endif
...
WNLine2<type>::WNLine2()
  : mPoint1(static_cast<type>(0)), mPoint2(static_cast<type>(0)) {}
...
WNLine2<type>::WNLine2(const type* _numbers)
  : mPoint1(&_numbers[0]), mPoint2(&_numbers[2]) {}
