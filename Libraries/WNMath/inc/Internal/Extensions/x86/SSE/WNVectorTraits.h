    ...
    namespace internal {
        namespace math {
            struct vector_traits_sse : vector_traits_generic {
                ...
                static WN_FORCE_INLINE typename core::enable_if<core::is_same<type, float>::value>::type length_squared(const element_array<float, 2>& _element_array) {
                ...
                template <typename type>
                static WN_FORCE_INLINE typename core::enable_if<core::is_same<type, float>::value, float>::type length_squared(const element_array<float, 4>& _element_array) {
                    const __m128 squared = _mm_mul_ps(_element_array.m_xmm_values[0], _element_array.m_xmm_values[0]);
                ...
                template <typename type>
                static WN_FORCE_INLINE typename core::enable_if<core::is_same<type, double>::value>::type normalize(element_array<float, 4>& _element_array) {
                    const __m128 squared = _mm_mul_ps(_element_array.m_xmm_values[0], _element_array.m_xmm_values[0]);
