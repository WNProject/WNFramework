...
struct basic_traits_sse : basic_traits_generic {
  ...
  template <typename type>
  static WN_FORCE_INLINE
      typename core::enable_if<core::is_same<float, type>::value, type>::type
      abs(const float& _value) {
    return (
        _mm_cvtss_f32(_mm_andnot_ps(_mm_set_ss(-0.0f), _mm_set_ss(_value))));
  }
  ...
  static WN_FORCE_INLINE
    ...
    return (_mm_cvtss_f32(
        _mm_div_ss(_mm_set_ss(1.0f), _mm_sqrt_ss(_mm_set_ss(_value)))));
#endif
  }
  ...
  static WN_FORCE_INLINE
      typename core::enable_if<core::is_same<float, type>::value, type>::type
      min(const float& _value1, const float& _value2) {
    return (
        _mm_cvtss_f32(_mm_min_ss(_mm_set_ss(_value1), _mm_set_ss(_value2))));
  }
  ...
  static WN_FORCE_INLINE
      typename core::enable_if<core::is_same<float, type>::value, type>::type
      max(const float& _value1, const float& _value2) {
    return (
        _mm_cvtss_f32(_mm_max_ss(_mm_set_ss(_value1), _mm_set_ss(_value2))));
  }
  ...
  static WN_FORCE_INLINE
      typename core::enable_if<core::is_same<float, type>::value, type>::type
      clamp(const float& _value, const float& _min, const float& _max) {
    return (_mm_cvtss_f32(_mm_min_ss(
        _mm_max_ss(_mm_set_ss(_value), _mm_set_ss(_min)), _mm_set_ss(_max))));
  }
