    ...
    namespace internal {
        namespace math {
            struct basic_traits_sse : basic_traits_generic {
                ...
                template <typename type>
                static WN_FORCE_INLINE typename enable_if<is_same<wn_float32, type>::value, type>::type abs(const wn_float32& _value) {
                ...
                template <typename type>
                static WN_FORCE_INLINE typename enable_if<is_same<wn_float32, type>::value, type>::type sqrt(const wn_float32& _value) {
                ...
                template <typename type>
                static WN_FORCE_INLINE typename enable_if<is_same<wn_float32, type>::value, type>::type invsqrt(const wn_float32& _value) {
                    #ifdef __WN_MATH_APPROXIMATIONS_ENABLED
                ...
                template <typename type>
                static WN_FORCE_INLINE typename enable_if<is_same<wn_float32, type>::value, type>::type min(const wn_float32& _value1, const wn_float32& _value2) {
                ...
                template <typename type>
                static WN_FORCE_INLINE typename enable_if<is_same<wn_float32, type>::value, type>::type max(const wn_float32& _value1, const wn_float32& _value2) {
                ...
                template <typename type>
                static WN_FORCE_INLINE typename enable_if<is_same<wn_float32, type>::value, type>::type clamp(const wn_float32& _value, const wn_float32& _min,
