...
namespace wn {
    namespace internal {
        ...
        WN_FORCE_INLINE type& __WNMatrixBaseCommon<MatrixType, type, Order>::operator [] (const uint32_t _index) {
        ...
        template <typename MatrixType, typename type, uint32_t Order>
        WN_FORCE_INLINE const type& __WNMatrixBaseCommon<MatrixType, type, Order>::operator [] (const uint32_t _index) const {
            WN_DEBUG_ASSERT_DESC(_index < (dimension), "Index out of range of matrix elements");
        ...
        template <typename MatrixType, typename type, uint32_t Order>
        WN_FORCE_INLINE type& __WNMatrixBaseCommon<MatrixType, type, Order>::operator () (const uint32_t _index1, const uint32_t _index2) {
        ...
        template <typename MatrixType, typename type, uint32_t Order>
        WN_FORCE_INLINE const type& __WNMatrixBaseCommon<MatrixType, type, Order>::operator () (const uint32_t _index1, const uint32_t _index2) const {
            WN_DEBUG_ASSERT_DESC(_index1 < Order, "Index out of range of matrix elements");
            WN_DEBUG_ASSERT_DESC(_index2 < Order, "Index out of range of matrix elements");
        ...
        WN_FORCE_INLINE bool __WNMatrixBaseCommon<MatrixType, type, dimension>::operator == (const MatrixType& _matrix) const {
        ...
        template <typename MatrixType, typename type, uint32_t Order>
        WN_FORCE_INLINE void __WNMatrixBaseCommon<MatrixType, type, Order>::Transpose() {
            const MatrixType matrix = *static_cast<MatrixType*>(this);
        ...
        template <typename MatrixType, typename type, uint32_t Order>
        WN_FORCE_INLINE bool __WNMatrixBaseCommon<MatrixType, type, Order>::IsIdentity() const {
            for (uint32_t i = 0; i < Order; ++i) {
                for (uint32_t j = 0; j < Order; ++j) {
                    if (i == j) {
        ...
        template <typename MatrixType, typename type, uint32_t Order>
        WN_FORCE_INLINE bool __WNMatrixBaseCommon<MatrixType, type, Order>::IsSymmetric() const {
            return(false);
        }

        template <typename MatrixType, typename type, uint32_t Order>
        WN_FORCE_INLINE bool __WNMatrixBaseCommon<MatrixType, type, Order>::IsDiagonal() const {
            for (uint32_t i = 0; i < Order; ++i) {
                for (uint32_t j = 0; j < Order; ++j) {
                    if (i != j) {
                        if (this->mElements.mValues[(j * Order) + i] != static_cast<type>(0)) {
        ...
        template <typename MatrixType, typename type, uint32_t Order>
        WN_FORCE_INLINE void __WNMatrixBaseCommon<MatrixType, type, Order>::Set(const MatrixType& _matrix) {
            *static_cast<MatrixType*>(this) = _matrix;
        }

        template <typename MatrixType, typename type, uint32_t Order>
        WN_FORCE_INLINE void __WNMatrixBaseCommon<MatrixType, type, Order>::Set(const type& _number) {
            this->mElements = __WNGeneralOpSetNumber<type, dimension>::Execute(this->mElements, _number);
        }

        template <typename MatrixType, typename type, uint32_t Order>
        WN_FORCE_INLINE void __WNMatrixBaseCommon<MatrixType, type, Order>::Set(const type* _numbers) {
