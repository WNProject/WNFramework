...
#error                                                                         \
    "Internal/WNMatrix3.inl should never be included directly. Please include WNMatrix3.h instead"
#endif
...
template <typename type>
WN_FORCE_INLINE void WNMatrix3<type>::MakeTranslation(
...
template <typename type>
WN_FORCE_INLINE void WNMatrix3<type>::MakeTranslation(
    const WNVector2<type>& _translation) {
...
template <typename type>
WN_FORCE_INLINE void WNMatrix3<type>::MakeScale(
    const type& _x, const type& _y) {
  // First Column
...
template <typename type>
WN_FORCE_INLINE WNMatrix3<type> WNMatrix3<type>::CreateTranslation(
    const type& _translation) {
...
template <typename type>
WN_FORCE_INLINE WNMatrix3<type> WNMatrix3<type>::CreateScale(
    const type& _scale) {
  WNMatrix3<type> matrix;
...
template <typename type>
WN_FORCE_INLINE WNMatrix3<type> operator+(
    const type& _number, const WNMatrix3<type>& _matrix) {
