...
#ifndef __WN_MATH_INTERNAL_GENERAL_OP_ADD_NUMBER_H__
#define __WN_MATH_INTERNAL_GENERAL_OP_ADD_NUMBER_H__
...
namespace WNMath {
    namespace __WNInternal {
        ...
        class __WNGeneralHelperAddNumber {
        ...
        private:
            WN_FORCE_INLINE __WNGeneralHelperAddNumber() {}
        };

        template <typename Type>
        class __WNGeneralHelperAddNumber<Type, 1> {
        public:
        ...
        template <typename Type>
        class __WNGeneralHelperAddNumber<Type, 2> {
        public:
        ...
        template <typename Type>
        class __WNGeneralHelperAddNumber<Type, 3> {
        public:
        ...
        template <typename Type>
        class __WNGeneralHelperAddNumber<Type, 4> {
        public:
        ...
        class __WNGeneralOpAddNumber {
            WN_STATIC_ASSERT_DESC(Dimension > 0, "Must have a dimension of at least 1");

        public:
            static WN_FORCE_INLINE __WNElements<Type, Dimension>& Execute(__WNElements<Type, Dimension>& _elements, const Type& _number) {
                return(__WNGeneralHelperAddNumber<Type, Dimension>::Execute(_elements, _number));
            }

        private:
            WN_FORCE_INLINE __WNGeneralOpAddNumber() {}
        };
    }
}
...
#include "WNMath/inc/WNConfig.h"
    ...
    #ifdef _WN_X86
        #include "WNMath/inc/Internal/x86/WNGeneralOpAddNumber.h"
    #endif
#endif

#endif // __WN_MATH_INTERNAL_GENERAL_OP_ADD_NUMBER_H__