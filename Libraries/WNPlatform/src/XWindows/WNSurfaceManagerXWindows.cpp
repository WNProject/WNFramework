...
WNSurfaceManagerReturnCode::type WNSurfaceManagerXWindows::CreateSurface(uint32_t _x, uint32_t _y, uint32_t _width, uint32_t _height, memory::intrusive_ptr<surface>& _surface) {
