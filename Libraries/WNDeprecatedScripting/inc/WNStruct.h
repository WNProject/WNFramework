...
namespace WNScripting {
    ...
    public:
        WNStruct(const char* _name, bool _isClass = false, const char* _parentType = NULL);
        virtual ~WNStruct();
        ...
        eWNTypeError FinalizeNewTypes(WNCodeModule& _module, std::vector<WNFunctionDefinition*>& _definitions, WNLogging::WNLog& _compilationLog);
    ...
    private:
        ...
        eWNTypeError GenerateCopyConstructor(WNCodeModule& _module, WNLogging::WNLog& _compilationLog);
        char* mName;
        char* mParentName;
        bool mIsClass;
