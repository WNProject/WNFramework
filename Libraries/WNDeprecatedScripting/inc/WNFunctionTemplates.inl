...
namespace WNScripting {
    ...
    eWNTypeError WNScriptingEngine::construct_scripting_object(WNScriptingObject<T1, T2>& _outType) {
    ...
    eWNTypeError WNScriptingEngine::register_cpp_Type() {
        ...
        register_external_type(TypeMapping<T>::get_type_name(), TypeMapping<TParent>::get_type_name(), &Destructor<T>);
        return(ok);
    }
    ...
    eWNTypeError WNScriptingEngine::get_pointer_to_function(const wn_char* _file, const wn_char* _functionName, WNFunctionPointer<R>& _outVal ) {
        ...
        std::vector<WNScriptType> params;
        void* ptr = NULL;
        if(ok != (err = get_function_pointer(_file, _functionName, t, params, ptr))){
            return(err);
        }
    ...
    eWNTypeError WNScriptingEngine::register_cpp_memberFunction(const wn_char* _name) {
        ...
        if(ok != (err = register_member_function(_name, objectType, ret, params, reinterpret_cast<void*>(&ObjectMethodStruct<T, R, P>::ObjectMethod)))){
            return(err);
        }
        return(ok);
    }
    ...
    eWNTypeError WNScriptingEngine::register_cpp_memberFunction(const wn_char* _name) {
        ...
        if(ok != (err = register_member_function(_name, objectType, ret, params, reinterpret_cast<void*>(&ObjectMethodStruct1<T, R, T1, P>::ObjectMethod)))){
            return(err);
        }
        return(ok);
    }
    ...
    eWNTypeError WNScriptingEngine::register_cpp_memberFunction(const wn_char* _name) {
        ...
        if(ok != (err = register_member_function(_name, objectType, ret, params, reinterpret_cast<void*>(&ObjectMethodStruct2<T, R, T1, T2, P>::ObjectMethod)))){
            return(err);
        }
        return(ok);
    }
    ...
    eWNTypeError WNScriptingEngine::register_cpp_memberFunction(const wn_char* _name) {
        ...
        if(ok != (err = register_member_function(_name, objectType, ret, params, reinterpret_cast<void*>(&ObjectMethodStruct3<T, R, T1, T2, T3, P>::ObjectMethod)))){
            return(err);
        }
        return(ok);
    }
    ...
    eWNTypeError WNScriptingEngine::register_cpp_memberFunction(const wn_char* _name) {
        ...
        if(ok != (err = register_member_function(_name, objectType, ret, params, reinterpret_cast<void*>(&ObjectMethodStruct4<T, R, T1, T2, T3, T4, P>::ObjectMethod)))){
            return(err);
        }
        return(ok);
    }
    ...
    eWNTypeError WNScriptingEngine::register_cpp_memberFunction(const wn_char* _name) {
        ...
        if(ok != (err = register_member_function(_name, objectType, ret, params, reinterpret_cast<void*>(&ObjectMethodStruct5<T, R, T1, T2, T3, T4, T5, P>::ObjectMethod)))){
            return(err);
        }
        return(ok);
    }
    ...
    eWNTypeError WNScriptingEngine::register_cpp_memberFunction(const wn_char* _name) {
        ...
        if(ok != (err = register_member_function(_name, objectType, ret, params, reinterpret_cast<void*>(&ObjectMethodStruct6<T, R, T1, T2, T3, T4, T5, T6, P>::ObjectMethod)))){
            return(err);
        }
        return(ok);
    }
    ...
    eWNTypeError WNScriptingEngine::register_c_function(const wn_char* _name, R (*_ptr)()) {
        ...
        eWNTypeError err;
        if(ok != (err = register_function(_name, t, params, reinterpret_cast<void*>(_ptr)))){
            return(err);
        }
        return(ok);
    }
