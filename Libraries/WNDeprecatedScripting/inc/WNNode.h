...
namespace WNScripting {
    ...
    class WNNode{
    public:
        void SetStartPosition(const WNScriptLocation& _location) { mStartLocation = _location; }
        void SetEndIndex(int64_t _idx) { mStartLocation.mEndIndex = _idx; }
        ...
        void LogLine(WNLogging::WNLog& _log, WNLogging::WNLogLevel _level) const {
            ...
            const char* c = wn::memory::strnchr(reinterpret_cast<const char*>(mStartLocation.mLineStart), '\n', lineLength);
