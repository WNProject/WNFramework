    ...
    namespace internal {
        ...
        namespace {
            ...
            struct select_scale_type {
                static_assert(dependent_false<_LowerType>::value, "type is not a valid integer type");
            };
        ...
        struct is_arithmetic_type<arithmetic_type<traits_type>> : std::true_type {};
    }
}

template <typename type1, typename type2>
typename wn::enable_if<(!wn::internal::is_arithmetic_type<type1>::value && wn::internal::is_arithmetic_type<type2>::value &&
                        (type2::template supported<type1>::value) &&
                        (type2::template higher_precedence<type1>::value)), type1>::type
operator + (const type1& _in_value1, const type2& _in_value2) {
    return(_in_value1 + type1(_in_value2));
}

template <typename type1, typename type2>
typename wn::enable_if<(!wn::internal::is_arithmetic_type<type1>::value && wn::internal::is_arithmetic_type<type2>::value &&
                        (type2::template supported<type1>::value) &&
                        !(type2::template higher_precedence<type1>::value)), type2>::type
operator + (const type1& _in_value1, const type2& _in_value2) {
    return(type2(_in_value1) + _in_value2);
}
...
template <typename type1, typename type2>
typename wn::enable_if<(!wn::internal::is_arithmetic_type<type1>::value && wn::internal::is_arithmetic_type<type2>::value && (type2::template supported<type1>::value) && (type2::template higher_precedence<type1>::value)), type1>::type operator / (const type1& _in_value1, const type2& _in_value2) {
    return(_in_value1 / type1(_in_value2));
}

template <typename type1, typename type2>
typename wn::enable_if<(!wn::internal::is_arithmetic_type<type1>::value && wn::internal::is_arithmetic_type<type2>::value && (type2::template supported<type1>::value) && !(type2::template higher_precedence<type1>::value)), type2>::type operator / (const type1& _in_value1, const type2& _in_value2) {
    return(type2(_in_value1) / _in_value2);
}
