...
WNGraphics::WNGraphicsDeviceReturnCode::type WNGraphics::WNGraphicsDeviceGLX::Initialize(uint32_t _adapter, uint32_t _output) {
...
WNGraphics::WNGraphicsDeviceReturnCode::type WNGraphics::WNGraphicsDeviceGLX::GetSize(uint32_t &_width, uint32_t &_height) {
    return(WNGraphics::WNGraphicsDeviceReturnCode::ok);
}

WNGraphics::WNShader* WNGraphics::WNGraphicsDeviceGLX::CreateShader(WNGraphics::WNShaderTypes _type, char* _shaderText) {
    return(nullptr);
}

WNGraphics::WNBuffer* WNGraphics::WNGraphicsDeviceGLX::CreateBuffer(WNGraphics::WNBufferTypes _type, uint32_t _elementSize, uint32_t _w, uint32_t _h, uint32_t _d) {
    return(nullptr);
}

WNGraphics::WNTexture* WNGraphics::WNGraphicsDeviceGLX::CreateTexture(WNGraphics::WNTextureTypes _type, WNGraphics::WNTextureFormat _format, uint32_t _elementSize, uint32_t _w, uint32_t _h, uint32_t _d) {
    return(nullptr);
}
...
WNGraphics::WNGraphicsDeviceReturnCode::type WNGraphics::WNGraphicsDeviceGLX::BindBuffer(WNGraphics::WNBuffer* _resource, uint32_t _location) {
    return(WNGraphics::WNGraphicsDeviceReturnCode::ok);
}

WNGraphics::WNGraphicsDeviceReturnCode::type WNGraphics::WNGraphicsDeviceGLX::BindTexture(WNGraphics::WNTexture* _texture, uint32_t _location) {
    return(WNGraphics::WNGraphicsDeviceReturnCode::ok);
}

WNGraphics::WNGraphicsDeviceReturnCode::type WNGraphics::WNGraphicsDeviceGLX::BindRenderTarget(WNGraphics::WNRenderTarget* _texture, uint32_t _location) {
    return(WNGraphics::WNGraphicsDeviceReturnCode::ok);
}
...
WNGraphics::WNGraphicsDeviceReturnCode::type WNGraphics::WNGraphicsDeviceGLX::BindSurface(wn::memory::intrusive_ptr<wn::surface>& _surface, bool _sync) {
