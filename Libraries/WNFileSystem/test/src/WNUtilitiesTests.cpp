...
TEST(path_tests, split_sanitized_path){
  ...
  EXPECT_TRUE(wn::file_system::internal::split_sanitized_path(path1, split_path_1));
  EXPECT_TRUE(wn::file_system::internal::split_sanitized_path(path2, split_path_2));
  EXPECT_TRUE(wn::file_system::internal::split_sanitized_path(path3, split_path_3));
  EXPECT_TRUE(wn::file_system::internal::split_sanitized_path(path4, split_path_4));
  EXPECT_TRUE(wn::file_system::internal::split_sanitized_path(path5, split_path_5));
  EXPECT_TRUE(wn::file_system::internal::split_sanitized_path(path6, split_path_6));
  EXPECT_TRUE(wn::file_system::internal::split_sanitized_path(path7, split_path_7));
  EXPECT_TRUE(wn::file_system::internal::split_sanitized_path(path8, split_path_8));
  EXPECT_TRUE(wn::file_system::internal::split_sanitized_path(path9, split_path_9));
  EXPECT_TRUE(wn::file_system::internal::split_sanitized_path(path10, split_path_10));
  EXPECT_TRUE(wn::file_system::internal::split_sanitized_path(path11, split_path_11));
  EXPECT_TRUE(wn::file_system::internal::split_sanitized_path(path12, split_path_12));
  EXPECT_TRUE(wn::file_system::internal::split_sanitized_path(path13, split_path_13));
  EXPECT_TRUE(wn::file_system::internal::split_sanitized_path(path14, split_path_14));
  EXPECT_TRUE(wn::file_system::internal::split_sanitized_path(path15, split_path_15));
  EXPECT_TRUE(wn::file_system::internal::split_sanitized_path(path16, split_path_16));
...
TEST(path_tests, get_pieces_from_sanitized_path) {
  ...
  wn::file_system::internal::get_directory_from_sanitized_path(path1, directory_piece_1);
  wn::file_system::internal::get_directory_from_sanitized_path(path2, directory_piece_2);
  wn::file_system::internal::get_directory_from_sanitized_path(path3, directory_piece_3);
  wn::file_system::internal::get_directory_from_sanitized_path(path4, directory_piece_4);
  wn::file_system::internal::get_directory_from_sanitized_path(path5, directory_piece_5);

  wn::file_system::internal::get_filename_from_sanitized_path(path1, file_piece_1);
  wn::file_system::internal::get_filename_from_sanitized_path(path2, file_piece_2);
  wn::file_system::internal::get_filename_from_sanitized_path(path3, file_piece_3);
  wn::file_system::internal::get_filename_from_sanitized_path(path4, file_piece_4);
  wn::file_system::internal::get_filename_from_sanitized_path(path5, file_piece_5);
