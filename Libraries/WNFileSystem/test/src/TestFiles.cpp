...
get_files() {
  static const wn::core::pair<wn::containers::string_view,
      ...
      file_data[] = {{wn::containers::string_view(_0, 7),
                         wn::containers::string_view(_0_data, 13)},
          {wn::containers::string_view(_1, 5),
              wn::containers::string_view(_1_data, 11)}};
  return wn::containers::contiguous_range<const wn::core::pair<
      wn::containers::string_view, wn::containers::string_view>>(
